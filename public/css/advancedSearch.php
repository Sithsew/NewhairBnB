        ...
        <div class=" form-group" style="padding-top: 5%">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <input class="form-control" type="number" value="0" placeholder="Minimum 0$" id="example-number-input" name="priceFrom">
        ...
        <div class=" form-group" style="padding-top: 5%">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <input class="form-control" type="number" value="10" placeholder="Minimum 60$" id="example-number-input" name="priceTo">
